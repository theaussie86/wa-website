---
title: "Zweites Gehirn für KI: Wie dein Business-Wissen jede KI-Session besser macht"
...
Du öffnest ChatGPT, Claude oder ein anderes KI-Tool. Du willst eine E-Mail an einen Kunden schreiben. Also briefst du erst mal: Wer du bist, was dein Unternehmen macht, wer der Kunde ist, wie du normalerweise schreibst. Fünf Minuten Kontext liefern, bevor die eigentliche Arbeit beginnt.
...
Ich erlebe das jeden Tag. Seit ich mein Business-Wissen strukturiert habe, sind die Outputs meiner KI-Tools von "brauchbar nach Überarbeitung" zu "direkt einsetzbar" geworden. Nicht bei allem, aber bei erstaunlich vielen Aufgaben.
...
### Stufe 2: Strategische Tiefe

- **Services und Angebote.** Was genau bietest du an? Zu welchen Konditionen? Was ist dein Einstiegsangebot, was ist dein Premium-Service?
- **Positionierung.** Was unterscheidet dich? Was machst du anders als die Konkurrenz? Worauf legst du Wert?
- **Content-Strategie.** Worüber sprichst du? Welche Themen passen zu dir, welche nicht?
...
Ich nutze Obsidian als Wissensbasis und Claude Code als KI-Agenten. Das ist mein Stack - nicht der einzige, der funktioniert, aber der, mit dem ich die besten Erfahrungen gemacht habe.

**Warum Obsidian?** Die Notizen sind einfache Markdown-Dateien auf meiner Festplatte. Kein Cloud-Zwang, kein Vendor-Lock-in. Wenn Obsidian morgen verschwindet, sind meine Daten immer noch da. Und: Obsidian hat ein CLI (Command Line Interface), das externen Tools den Zugriff erlaubt.

**Warum Claude Code?** Es läuft lokal auf meinem Rechner und kann über das Obsidian CLI selbstständig auf mein Wissen zugreifen. Ich muss nichts kopieren, nichts hochladen. Die KI fragt mein zweites Gehirn, bevor sie antwortet.
...
**Google Docs + Gemini:** Wenn dein Wissen in Google Docs liegt, kann Gemini direkt darauf zugreifen. Kein Umzug nötig, du arbeitest mit dem, was du hast.
...
Du musst nicht alles auf einmal aufbauen. Hier sind fünf Schritte, die dich in einer Woche zum ersten Ergebnis bringen:

**1. Schreib auf, wer du bist.** Ein Dokument, eine Seite. Dein Name, dein Business, was du machst, für wen. 15 Minuten.

**2. Beschreib deine Zielgruppe.** Wer sind deine Kunden? Welche Probleme haben sie? Was ist ihnen wichtig? Wieder ein Dokument, wieder 15 Minuten.
...
Das ist kein Wochenendprojekt. Das sind drei Dokumente und ein Experiment. Und wenn es funktioniert - und das wird es - kannst du immer noch entscheiden, ob du ein ausgewachsenes System mit automatischem KI-Zugriff aufbaust.

## Fazit: Dein Wissen ist der Multiplikator

KI-Tools werden jedes Jahr besser. Neue Modelle, neue Features, neue Möglichkeiten. Aber egal wie gut das Modell ist - ohne dein Wissen liefert es generische Ergebnisse.

Dein Second Brain ist der Multiplikator. Es macht jedes KI-Tool besser, weil es den Kontext liefert, der generische Outputs in brauchbare verwandelt. Und es macht dich unabhängig vom spezifischen Tool - dein Wissen bleibt bei dir, egal welche KI du morgen nutzt.

Der wichtigste Schritt ist nicht das perfekte Setup. Es ist der erste: Schreib auf, wer du bist und was du machst. Alles andere ergibt sich.

---

**Du willst das Schritt für Schritt aufbauen?** Ich arbeite gerade an einer kompakten Anleitung, die dich vom leeren Dokument zum funktionierenden Second Brain bringt - mit konkreten Vorlagen und Beispielen. [Trag dich auf die Warteliste ein](/second-brain-anleitung) und ich schicke sie dir, sobald sie fertig ist.
